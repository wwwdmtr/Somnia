      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.textBlock}>
            ...
            <Text style={typography.body_white85}>
              Идея проекта - собрать университетскую жизнь в одном месте,
              сделать так, чтобы важная информация больше не была разбросана по
              десяткам чатов, каналов и личных сообщений, а находилась в одном
              месте и была доступна каждому студенту. <br></br> <br></br>Кто-то
