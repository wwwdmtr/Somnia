      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.textBlock}>
            ...
            <Text style={typography.body_white85}>
              Идея проекта - собрать университетскую жизнь в одном месте, чтобы
              тут встречались как официальные объявления от университета,
              кафедр, студенческих организаций и клубов, так и инициативы самих
              студентов. Сделать так, чтобы важная информация больше не была
              разбросана по десяткам чатов, каналов и личных сообщений.
            </Text>
            <Text style={typography.body_white85}>
              Кто-то ищет модель на съемку, кто-то - музыкантов или команду для
